            ...
            <el-col :span="24" class="ct_left_box">
                <el-col :span="24" class="topInfor">
                    ...
                    <div class="titleBox" v-for="(data,index) in inforData"    :key="index">
                        ...
                        <div style="height: 23px;margin-bottom: 5px;">
                            <el-col :span="24"  class="infor_a">
                                <el-col :span="5" class="title" style="font-size: 16px;color: #000;">
                                    账户币
                                </el-col>
                                <el-col :span="19" class="input_search">
    ...
    export default {
        data() {
          ...
          watch:{
              item(val){
                  this.inforData = [];
                  this.zczhanghuA_users = val.data.zczhanghu.a_users;
                  this.inforData.push(val.contract_zhuanchu);
                  this.rebates_proportion = val.contract_zhuanchu.mht.rebates_proportion;
                  this.fandian = val.contract_zhuanchu.rencontract.fandian;
                  this.money = Number(val.data.money)*(1+(Number(val.contract_zhuanchu.rencontract.fandian))/100)
            },
          },
        methods:{
