            ...
            return {
                ...
                meijie_bukuan_list:function(page,num,val){
                    ...
                    meijie_bukuan_list({
                        ...
                        this.pageSize =  this.search_list.meiti_bukuan_page?this.search_list.meiti_bukuan_page:20;
                        this.pageIndex = this.search_list.meiti_bukuan_num ?this.search_list.meiti_bukuan_num :1;
                ...
                meijie_bukuan_listExcel:function(page,num,val){
                    ...
                    meijie_bukuan_list({
                        ...
                        require.ensure([], () => {
                            ...
                            const tHeader = [this.$t('titles.customer'),'媒体合同名称', '简称','备款账户', '补款金额','补账户币','创建日期','补款日期','提交人'];
                            const filterVal = ['submituserName', 'title','appname', 'bu_a_users','money','show_money','ctime','bu_time','submitname'];
...
//表格
        ...
        mounted(){
            ...
            this.dataInfor.search['Search_str'] = this.search_list.meiti_bukuan_name;

            this.dataInfor.search['date_type'] = this.search_list.meiti_bukuan_date_type?this.search_list.meiti_bukuan_date_type:1;
            this.dataInfor.search['start_date'] = this.search_list.meiti_bukuan_start_date;
            this.dataInfor.search['end_date'] = this.search_list.meiti_bukuan_end_date;
            this.dataInfor.search['shenhe'] = this.search_list.meiti_bukuan_shenhe;
            this.dataInput = [this.search_list.meiti_bukuan_start_date,this.search_list.meiti_bukuan_end_date];
            this.date_type = this.search_list.meiti_bukuan_date_type?this.search_list.meiti_bukuan_date_type:1;
            this.shenhe = this.search_list.meiti_bukuan_shenhe;
            this.pageSize =  this.search_list.meiti_bukuan_page?this.search_list.meiti_bukuan_page:20;
            this.pageIndex = this.search_list.meiti_bukuan_num ?this.search_list.meiti_bukuan_num :1;
            this.kehuTableLength = this.search_list.meiti_bukuan_length ?this.search_list.meiti_bukuan_length :0;
            ...
            this.screen = [
                {
                    name:'搜索',
                    infor: this.search_list.meiti_bukuan_name
                }
            ];
        },
        methods: {
            ...
            searchDataFun(){
                this.searchData({
                    meiti_bukuan_name: this.dataInfor.search.Search_str,
                    meiti_bukuan_date_type: this.dataInfor.search.date_type,
                    meiti_bukuan_start_date: this.dataInfor.search.start_date,
                    meiti_bukuan_end_date: this.dataInfor.search.end_date,
                    meiti_bukuan_shenhe: this.dataInfor.search.shenhe,
                    meiti_bukuan_page:this.pageSize,
                    meiti_bukuan_num:this.pageIndex,
                    meiti_bukuan_length:this.kehuTableLength,
                });
            },
            //搜索日期条件选择
            dateTypeChange(){
...
//清除
            searchClear(){
                ...
                this.searchData({
                    meiti_bukuan_name:'',
                    meiti_bukuan_date_type: '',
                    meiti_bukuan_start_date: '',
                    meiti_bukuan_end_date: '',
                    meiti_bukuan_shenhe: '',
...
//点击tr
            clickTr(val){
                this.$router.push({ name: 'mediareplenishment',query: { id:val.id,mhtId:val.mht_id} });
