<template>
    <div class="addhuikuanList ku_addBox">
        <el-row class="addhuikuanBox">
            <p class="crm_title">
                <i class="crm_line"></i>
                <span @click="jumpCustomerList">媒体列表</span>><span @click="jumpConsole">客户控制台</span>><span>添加媒体发票</span>
            </p>
                        ...
                        <div class="titleBox" v-for="(data,index) in formData" :key="index">
                            ...
                            <div style="height: 30px;margin-bottom: 5px;">
                                <el-col :span="24"  class="infor_a">
                                    ...
                                    <el-col :span="20" class="input_search">
                                        <el-input class="inputText" v-model="data.money" placeholder="请输入内容"  v-on:input="judgeData">
...
<script>
    ...
    import {invoice_addruPost,invoice_addInfor,invoice_typeInfor} from '@/api/kehu';
...
//                        "contract_no":"",
                ...
                invoice_addInfor:function(val){
                    invoice_addInfor({
                        ...
                        this.e_du = Number(response.customer.yu_e) - Number(response.customer.fapiao)
        ...
        methods: {
            is_back_moneyChange(index){
                this.formData[0].is_back_money = index;
            },
            ...
            pullData(){
                let data = '';
                if( Number(this.formData[0].money) > this.e_du){
                    data = '您的开票额度超过当前发票额度（'+this.e_du+'），是否继续?'
                }else{
                    data = '提交后不可更改，是否继续?'
                }
                this.tan(data)
