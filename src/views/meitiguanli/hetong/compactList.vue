                ...
                return {
                    ...
                    customer_contract_list_new:function(page,num,val){
                        ...
                        customer_contract_list_new({
                            ...
                            this.pageSize =  this.search_list.meiti_hetong_page?this.search_list.meiti_hetong_page:20;
                            this.pageIndex = this.search_list.meiti_hetong_num ?this.search_list.meiti_hetong_num :1;
                    ...
                    customer_contract_list_newExcel:function(){
                        ...
                        customer_contract_list_new({
                            ...
                            let data = [];
                            let tHeaderData =  [this.$t('titles.customer'), '简称', '媒介合同','代理公司','负责商务', '创建时间', '合同属性','账期','提交人','归档编号','备注'];
                            let filterValData =  ['advertiseraccount', 'appname', 'contract_no','companyname','advertiserName','ctime', 'contract_state','zhouqi','submitname','guidang_no','note'];
...
//                                item.rencontract.filter(function(data,i) {
//
//                                })
            ...
            mounted(){
                ...
                this.screen =[
                    {
                        name:'搜索',
                        data: this.search_list.meiti_hetong_name
                    }
                ];
                this.dataInfor.search['Search_str'] = this.search_list.meiti_hetong_name;
                this.dataInfor.search['date_type'] = this.search_list.meiti_hetong_date_type?this.search_list.meiti_hetong_date_type:1;
                this.dataInfor.search['start_date'] = this.search_list.meiti_hetong_start_date;
                this.dataInfor.search['end_date'] = this.search_list.meiti_hetong_end_date;
                this.dataInfor.search['shenhe'] = this.search_list.meiti_hetong_shenhe;
                this.dataInfor.search['isguidang'] = this.search_list.meiti_hetong_guidang;
                this.dataInfor.search['pr_id'] = this.search_list.meiti_hetong_selectLine;
                this.dataInput = [this.search_list.meiti_hetong_start_date,this.search_list.meiti_hetong_end_date];
                this.date_type = this.search_list.meiti_hetong_date_type?this.search_list.meiti_hetong_date_type:1;
                this.shenhe = this.search_list.meiti_hetong_shenhe;
                this.selectLine = this.search_list.meiti_hetong_selectLine;
                this.guidang = this.search_list.meiti_hetong_guidang;

                this.pageSize =  this.search_list.meiti_hetong_page?this.search_list.meiti_hetong_page:20;
                this.pageIndex = this.search_list.meiti_hetong_num ?this.search_list.meiti_hetong_num :1;
                this.kehuTableLength = this.search_list.meiti_hetong_length ?this.search_list.meiti_hetong_length :1;
            ...
            methods: {
                ...
                searchDataFun(){
                    this.searchData({
                        meiti_hetong_name: this.dataInfor.search.Search_str,
                        meiti_hetong_date_type: this.dataInfor.search.date_type,
                        meiti_hetong_start_date: this.dataInfor.search.start_date,
                        meiti_hetong_end_date: this.dataInfor.search.end_date,
                        meiti_hetong_shenhe: this.dataInfor.search.shenhe,
                        meiti_hetong_guidang: this.dataInfor.search.isguidang,
                        meiti_hetong_selectLine: this.dataInfor.search.pr_id,
                        meiti_hetong_page:this.pageSize,
                        meiti_hetong_num:this.pageIndex,
                        meiti_hetong_length:this.kehuTableLength
                    });
                },
                //搜索日期条件选择
                dateTypeChange(){
...
//清除
                searchClear(){
                    ...
                    this.searchData({
                        meiti_hetong_name: '',
                        meiti_hetong_date_type: '',
                        meiti_hetong_start_date: '',
                        meiti_hetong_end_date: '',
                        meiti_hetong_shenhe: '',
                        meiti_hetong_guidang: '',
                        meiti_hetong_selectLine: '',
                    });
