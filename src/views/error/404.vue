<template>
  <div style="background:#f0f2f5;margin-top: -20px;">
    <div class="wscn-http404">
      <div class="pic-404">
        <img class="pic-404__parent" src="http://test.myushan.com/ZPCRM404.png" alt="404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">OOPS!</div>
         <div class="bullshit__info">版权所有<a class='link-type' href='https://www.lzad.cc' target='_blank'>北京谋士网络科技有限公司</a></div>
