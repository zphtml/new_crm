...
<script>
    ...
    import { kehu_margin_tui_info } from '@/api/kehu';
    ...
    export default {
        ...
        data() {
            return {
                ...
                kehu_margin_tui_info:function(){
                    kehu_margin_tui_info( this.routeId).then(response => {
        ...
        methods: {
            ...
            shenheInfor(val){
                this.shenheapi_a(val.shenheInfor, this.routeId,'kehu_margin_tui_shenhe'+val.shenheInfor.shenhe)
            },
            newcontact(val){
                this.kehu_margin_tui_info();
            },
