            ...
            return {
                ...
                yihuikuanxufei_list:function(page,num,val){
                    ...
                    yihuikuanxufei_list({
                        ...
                        this.pageSize =  this.search_list.caiwu_gs_bukuan_page?this.search_list.caiwu_gs_bukuan_page:20;
                        this.pageIndex = this.search_list.caiwu_gs_bukuan_num ?this.search_list.caiwu_gs_bukuan_num :1;
                ...
                yihuikuanxufei_listExcel:function(num){
                    ...
                    yihuikuanxufei_list({
                        ...
                        const tHeader = [this.$t('titles.customer'), '产品线','补款金额',
                            '实付金额','利润','销售','补款时间','认款时间',
                            '备注'];
                         const filterVal = ['adname', 'prlinname','money',
                             'money','lirun','name','xftime','time',
                              'note'];
                        const list = this.tableData;
                        const data = this.formatJson(filterVal, list);
                        export_json_to_excel(tHeader, data, '公司补款');
                    })
...
//表格
        ...
        methods: {
            ...
            gs_bukuanList(){
                ...
                this.dataInfor.search['ktype'] = 'bukuan';


                this.dataInfor.search['Search_str'] = this.search_list.caiwu_gs_bukuan_name;
                this.dataInfor.search['date_type'] = this.search_list.caiwu_gs_bukuan_date_type?this.search_list.caiwu_gs_bukuan_date_type:1;
                this.dataInfor.search['start_date'] = this.search_list.caiwu_gs_bukuan_start_date;
                this.dataInfor.search['end_date'] = this.search_list.caiwu_gs_bukuan_end_date;
                this.inputText = this.search_list.caiwu_gs_bukuan_name;
                this.dataInput = [this.search_list.caiwu_gs_bukuan_start_date,this.search_list.caiwu_gs_bukuan_end_date];
                this.date_type = this.search_list.caiwu_gs_bukuan_date_type?this.search_list.caiwu_gs_bukuan_date_type:1;
                this.pageSize =  this.search_list.caiwu_gs_bukuan_page?this.search_list.caiwu_gs_bukuan_page:20;
                this.pageIndex = this.search_list.caiwu_gs_bukuan_num ?this.search_list.caiwu_gs_bukuan_num :1;
                this.kehuTableLength = this.search_list.caiwu_gs_bukuan_length ?this.search_list.caiwu_gs_bukuan_length :1;
                this.yihuikuanxufei_list(this.page,this.num,this.dataInfor);

            },
            searchDataFun(){
                this.searchData({
                    caiwu_gs_bukuan_name: this.dataInfor.search.Search_str,
                    caiwu_gs_bukuan_date_type: this.dataInfor.search.date_type,
                    caiwu_gs_bukuan_start_date: this.dataInfor.search.start_date,
                    caiwu_gs_bukuan_end_date: this.dataInfor.search.end_date,
                    caiwu_gs_bukuan_page:this.pageSize,
                    caiwu_gs_bukuan_num:this.pageIndex,
                    caiwu_gs_bukuan_length:  this.kehuTableLength
                });
            },
            //搜索
            searchInput(){
...
//清除
            searchClear(){
                ...
                this.yihuikuanxufei_list(this.page,this.num,this.dataInfor);
                this.searchData({
                    caiwu_gs_bukuan_name:'',
                    caiwu_gs_bukuan_date_type: '',
                    caiwu_gs_bukuan_start_date: '',
                    caiwu_gs_bukuan_end_date: '',
                });
            },
        },
        created() {
