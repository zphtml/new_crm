...
//
                        ...
                        this.pageSize =  this.search_list.caiwu_huikuan_page?this.search_list.caiwu_huikuan_page:20;
                        this.pageIndex = this.search_list.caiwu_huikuan_num ?this.search_list.caiwu_huikuan_num :1;
                ...
                huikuan_listPostExcel:function(page,num,val){
                    ...
                    huikuan_listPost({
                        ...
                        require.ensure([], () => {
                            ...
                            const tHeader = [this.$t('titles.customer'), '简称','回款金额', '回款时间','创建日期', '提交人','回款人','备注'];
                            const filterVal = ['adname', 'appname', 'b_money','b_time','ctime','submitname','huikuanren','note'];
...
//表格
        ...
        mounted(){
            ...
            this.dataInfor.search['Search_str'] = this.search_list.caiwu_huikuan_name;
            this.dataInfor.search['date_type'] = this.search_list.caiwu_huikuan_date_type?this.search_list.caiwu_huikuan_date_type:1;
            this.dataInfor.search['start_date'] = this.search_list.caiwu_huikuan_start_date;
            this.dataInfor.search['end_date'] = this.search_list.caiwu_huikuan_end_date;
            this.dataInfor.search['shenhe'] = this.search_list.caiwu_huikuan_shenhe;
            this.dataInput = [this.search_list.caiwu_huikuan_start_date,this.search_list.caiwu_huikuan_end_date];
            this.date_type = this.search_list.caiwu_huikuan_date_type?this.search_list.caiwu_huikuan_date_type:1;
            this.shenhe = this.search_list.caiwu_huikuan_shenhe;
            this.pageSize =  this.search_list.caiwu_huikuan_page?this.search_list.caiwu_huikuan_page:20;
            this.pageIndex = this.search_list.caiwu_huikuan_num ?this.search_list.caiwu_huikuan_num :1;
            this.kehuTableLength = this.search_list.caiwu_huikuan_length ?this.search_list.caiwu_huikuan_length :1;
            this.huikuan_listPost(this.page,this.num,this.dataInfor);
            this.screen = [
                {
                    name:'搜索',
                    data: this.search_list.caiwu_huikuan_name
                }
            ];
        ...
        methods: {
            ...
            searchDataFun(){
                this.searchData({
                    caiwu_huikuan_name: this.dataInfor.search.Search_str,
                    caiwu_huikuan_date_type: this.dataInfor.search.date_type,
                    caiwu_huikuan_start_date: this.dataInfor.search.start_date,
                    caiwu_huikuan_end_date: this.dataInfor.search.end_date,
                    caiwu_huikuan_shenhe: this.dataInfor.search.shenhe,
                    caiwu_huikuan_length:this.kehuTableLength,
                    caiwu_huikuan_page:this.pageSize,
                    caiwu_huikuan_num:this.pageIndex,
                });
            },
            //搜索日期条件选择
            dateTypeChange(){
...
//清除
            searchClear(){
                ...
                this.searchData({
                    caiwu_huikuan_name:'',
                    caiwu_huikuan_date_type: '',
                    caiwu_huikuan_start_date: '',
                    caiwu_huikuan_end_date: '',
                    caiwu_huikuan_shenhe: '',
                });
            },
//点击tr
            clickTr(val){
